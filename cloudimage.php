<?php
/**
 * Cloudimage by Scaleflex - Responsive Images as a Service
 *
 *
 ...
 */
define('CLOUDIMAGE_VERSION', '4.0.2');

//get all config of old version
$options = get_option('cloudimage');
if (!$options) {
    $isNewVersion = true;
} else {
    $isNewVersion = $options['cloudimage_new_version'];
}

if ($isNewVersion) {
    require plugin_dir_path(__FILE__) . 'v4/cloudimage.php';
} else {
    /**
