...
class Cloudimage
{
    ...
    private function define_admin_hooks()
    {
        ...
        $this->loader->add_action('wp_ajax_cloudimage_check_v7', $plugin_admin, 'cloudimage_check_v7');
    ...
    private function define_public_hooks()
    {
        ...
        $this->loader->add_filter(
            'wp_prepare_attachment_for_js', $plugin_public, 'filter_cloudimage_wp_prepare_attachment_for_js',
            10, 3
        );
